               ...
               char *error_str)
{
    ...
    for(i=1; i < 4;i++)
    {
        ...
        ((char**)for_cmd_detail)[i] = malloc(strlen(tmp_buff));
        memcpy(((char**)for_cmd_detail)[i], tmp_buff, strlen(tmp_buff));
    }
